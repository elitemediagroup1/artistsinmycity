...
## Purpose
Fan accounts make the consumer side sticky.

## Required Navigation
Overview, Following, Favorites, Messages, Events, Tickets, Purchases, Merch, Saved Artists, Notifications, Settings.
...
- Buy merch preview.
- Tickets preview.
- Booking/commission interest preview.
