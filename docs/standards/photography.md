...
## Standard
This file defines the photography standard for ArtistsInMyCity.

## Implementation
Preserve the dark premium Spotify x MoMA design. Reuse existing CSS variables and components. Do not create one-off styles unless a documented component requires it.

## Acceptance
Consistent across homepage, city pages, dashboards, Roadie, events, legal pages, and portal screens.
