...
## Required Navigation
Users, Artists, Fans, Creators, Cities, Categories, Events, Featured Slots, Sponsorships, Payments, Moderation, Reports, Loop Events, API Status, Settings.

## Admin Capabilities
Approve artists, manage homepage slots, review content, monitor webhook events, inspect integrations, manage legal/footer links, and moderate chat/messages.
