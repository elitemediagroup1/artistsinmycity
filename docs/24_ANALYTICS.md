...
## Analytics Stack
GA4, GTM, Clarity, Meta Pixel, TikTok Pixel, EMG LOOP.

## Events
page_view, search, city_view, category_view, artist_signup_start, artist_signup_complete, fan_signup_complete, follow_artist, favorite_artist, roadie_opened, ai_generation_requested, preview_clicked, publish_clicked, merch_clicked, ticket_clicked, booking_clicked.
