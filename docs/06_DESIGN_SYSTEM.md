...
## Components
Use consistent cards, buttons, dashboard panels, inputs, modals, hero sections, city cards, artist cards, event cards, and Roadie widgets.

## Card Rules
Rounded corners, dark overlay when image based, readable text, lazy-loaded images, hover lift on desktop.

## Motion
Subtle fades, lifts, glows, and hero transitions. Avoid distracting motion.
