...
## V1
Clickable customer-ready platform with portals, Roadie, city pages, events UI, SEO/AEO, integration placeholders.

## V2
Real auth, Neon persistence, media uploads, Claude responses, Stripe plans, Loop events.

## V3
Live event APIs, merch/ticket transactions, DMs, public chat, creator publishing.

## V4
Recommendations, artist analytics, city creator programs, sponsorship marketplace.
