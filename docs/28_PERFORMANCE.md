...
## Goals
Fast, image-heavy but optimized. Lighthouse target 90+ where practical.

## Requirements
Lazy-load images, compress assets, avoid layout shift, defer noncritical scripts, minimize duplicate CSS/JS, avoid large blocking third-party scripts.
