...
- Clerk app created with roles.
- Neon database created and schema applied.
- Claude API key added to Netlify env.
- Stripe account/products/webhooks configured.
- GitHub token/deploy permissions configured.
- Netlify build hook configured.
- EMG LOOP webhook URL configured.
- GA4/GTM/Clarity/Meta/TikTok configured.
- IndexNow key hosted and configured.
- Cloudinary/UploadThing media configured.
- Ticketmaster/Eventbrite/Bandsintown/SeatGeek keys requested.

## First Customer Readiness
Artist signup and portal must work end-to-end. Fan signup and portal must work end-to-end. Roadie must open and provide preview help without exposing Claude.
